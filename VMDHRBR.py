...
def VMDHRBR(HRsignal):
    # 低带3Hz
    hr_filter = [0.0309909673242566,-0.165661939691912,0.0108793969808390,0.0324236783132672,0.0199968912456759,-0.000613578794395767,-0.0174981843140624,-0.0209931469194497,-0.00877704765628144,0.0108700045894203,0.0230147108320965,0.0169173382647123,-0.00452647999755323,-0.0249793770879194,-0.0263563796709082,-0.00399704934895674,0.0266844715479274,0.0395500004882902,0.0181203159485759,-0.0279207261245773,-0.0638278713762797,-0.0504032960259331,0.0287131587511762,0.150153024415508,0.260050540027963,0.304523197983351,0.260050540027963,0.150153024415508,0.0287131587511762,-0.0504032960259331,-0.0638278713762797,-0.0279207261245773,0.0181203159485759,0.0395500004882902,0.0266844715479274,-0.00399704934895674,-0.0263563796709082,-0.0249793770879194,-0.00452647999755323,0.0169173382647123,0.0230147108320965,0.0108700045894203,-0.00877704765628144,-0.0209931469194497,-0.0174981843140624,-0.000613578794395767,0.0199968912456759,0.0324236783132672,0.0108793969808390,-0.165661939691912,0.0309909673242566]
            ...
            if flagheart==0 and flagbreath==0:
                for i in range(K):
                    if 50 <= provalue[0,i] <= 120:  # 如果有中心频率在心率的范围内
                        ...
                        flagheart = 1  # 分解出了心率
                    if 5 <= provalue[0,i] <= 40:  # 如果有中心频率在呼吸频率的范围内
